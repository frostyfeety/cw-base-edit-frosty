...
CustomizableWeaponry.colorableParts.COLOR_TYPE_PART = 3
CustomizableWeaponry.colorableParts.colors = {[CustomizableWeaponry.colorableParts.COLOR_TYPE_SIGHT] = {},
	[CustomizableWeaponry.colorableParts.COLOR_TYPE_BEAM] = {},
		[CustomizableWeaponry.colorableParts.COLOR_TYPE_PART] = {}}
...
CustomizableWeaponry.colorableParts.colorText = {[CustomizableWeaponry.colorableParts.COLOR_TYPE_SIGHT] = " (HOLD - change reticle color)",
	...
	[CustomizableWeaponry.colorableParts.COLOR_TYPE_PART] = " (HOLD - change part color)"}
...
function CustomizableWeaponry.colorableParts:addPartColor(part)
	--self.laserColors[laser.part] = part
	table.insert(self.colors[self.COLOR_TYPE_PART], part)
end
...
[CustomizableWeaponry.colorableParts.COLOR_TYPE_PART] = CustomizableWeaponry.colorableParts.colors[CustomizableWeaponry.colorableParts.COLOR_TYPE_PART][1]}