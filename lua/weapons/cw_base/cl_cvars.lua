...
CreateClientConVar("cw_physical_bullets", 0, true, true)

CreateClientConVar("cwc_subsound_lowcount", 1, true, true)
CreateClientConVar("cwc_subsound_pov", 1, true, true)
CreateClientConVar("cwc_subsound_empty", 1, true, true)
CreateClientConVar("cwc_shell_audio", 1, true, true)

CreateClientConVar("cwc_sprint_fov", 1, true, true)
CreateClientConVar("cwc_reload_bob", 1, true, true)
CreateClientConVar("cwc_fovpunch", 1, true, true)
CreateClientConVar("cwc_spawnwithsafemode", 1, true, true)